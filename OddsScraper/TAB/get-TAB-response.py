...
OUTPUT_PATH = "OddsScraper/TAB/tab_response.json"
...
async def main():
    ...
    async with webdriver.Chrome(options=options) as driver:
        ...
        api_url = "https://api.beta.tab.com.au/v1/tab-info-service/sports/American%20Football/competitions/NFL?jurisdiction=SA"
